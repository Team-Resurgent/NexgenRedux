...
{
class AngelScriptDebuggerCore
{
	public:
		AngelScriptDebuggerCore();
		virtual ~AngelScriptDebuggerCore();
		...
		typedef std::string (*ToStringCallback)(void *obj, int expandMembersLevel, AngelScriptDebuggerCore *dbg);
