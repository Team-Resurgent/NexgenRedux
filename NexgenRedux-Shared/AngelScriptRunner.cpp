...
bool AngelScriptRunner::Init(std::wstring launchFolder)
{
	...
	result = m_engine->RegisterObjectType("OrthoCamera", sizeof(0), asOBJ_REF | asOBJ_NOCOUNT); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "uint GetID()", asMETHOD(OrthoCamera, GetID), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "Vec3F& GetAnchor()", asMETHOD(OrthoCamera, GetAnchor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetAnchor(Vec3F)", asMETHOD(OrthoCamera, SetAnchor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "Vec3F& GetRotation()", asMETHOD(OrthoCamera, GetRotation), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetRotation(Vec3F)", asMETHOD(OrthoCamera, SetRotation), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "Vec3F& GetSkew()", asMETHOD(OrthoCamera, GetSkew), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetSkew(Vec3F)", asMETHOD(OrthoCamera, SetSkew), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "Vec3F& GetScale()", asMETHOD(OrthoCamera, GetScale), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetScale(Vec3F)", asMETHOD(OrthoCamera, SetScale), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "Vec3F& GetPosition()", asMETHOD(OrthoCamera, GetPosition), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetPosition(Vec3F)", asMETHOD(OrthoCamera, SetPosition), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "Color4F& GetClearColor()", asMETHOD(OrthoCamera, GetClearColor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetClearColor(Color4F)", asMETHOD(OrthoCamera, SetClearColor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "Vec3F& GetEye()", asMETHOD(OrthoCamera, GetEye), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetEye(Vec3F)", asMETHOD(OrthoCamera, SetEye), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "Vec3F& GetTarget()", asMETHOD(OrthoCamera, GetTarget), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetTarget(Vec3F)", asMETHOD(OrthoCamera, SetTarget), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "Vec3F& GetUp()", asMETHOD(OrthoCamera, GetUp), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetUp(Vec3F)", asMETHOD(OrthoCamera, SetUp), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "float GetLeft()", asMETHOD(OrthoCamera, GetLeft), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetLeft(float)", asMETHOD(OrthoCamera, SetLeft), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "float GetRight()", asMETHOD(OrthoCamera, GetRight), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetRight(float)", asMETHOD(OrthoCamera, SetRight), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "float GetBottom()", asMETHOD(OrthoCamera, GetBottom), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetBottom(float)", asMETHOD(OrthoCamera, SetBottom), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "float GetTop()", asMETHOD(OrthoCamera, GetTop), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetTop(float)", asMETHOD(OrthoCamera, SetTop), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "float GetZNear()", asMETHOD(OrthoCamera, GetZNear), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetZNear(float)", asMETHOD(OrthoCamera, SetZNear), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "float GetZFar()", asMETHOD(OrthoCamera, GetZFar), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("OrthoCamera", "void SetZFar(float)", asMETHOD(OrthoCamera, SetZFar), asCALL_THISCALL); if (result < 0) { return false; }
	
	result = m_engine->RegisterObjectType("Sprite", sizeof(0), asOBJ_REF | asOBJ_NOCOUNT); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "uint GetID()", asMETHOD(Sprite, GetID), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "Vec3F& GetAnchor()", asMETHOD(Sprite, GetAnchor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetAnchor(Vec3F)", asMETHOD(Sprite, SetAnchor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "Vec3F& GetRotation()", asMETHOD(Sprite, GetRotation), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetRotation(Vec3F)", asMETHOD(Sprite, SetRotation), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "Vec3F& GetSkew()", asMETHOD(Sprite, GetSkew), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetSkew(Vec3F)", asMETHOD(Sprite, SetSkew), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "Vec3F& GetScale()", asMETHOD(Sprite, GetScale), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetScale(Vec3F)", asMETHOD(Sprite, SetScale), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "Vec3F& GetPosition()", asMETHOD(Sprite, GetPosition), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetPosition(Vec3F)", asMETHOD(Sprite, SetPosition), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "string GetTexturePath()", asMETHOD(Sprite, GetTexturePath), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetTexturePath(string)", asMETHOD(Sprite, SetTexturePath), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "RectF& GetUV()", asMETHOD(Sprite, GetUV), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetUV(RectF)", asMETHOD(Sprite, SetUV), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "SizeF& GetSize()", asMETHOD(Sprite, GetSize), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetSize(SizeF)", asMETHOD(Sprite, SetSize), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "Color4F& GetTint()", asMETHOD(Sprite, GetTint), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetTint(Color4F)", asMETHOD(Sprite, SetTint), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "BlendOperation GetBlend()", asMETHOD(Sprite, GetBlend), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetBlend(BlendOperation)", asMETHOD(Sprite, SetBlend), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "BlendFactor GetBlendFactorSrc()", asMETHOD(Sprite, GetBlendFactorSrc), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetBlendFactorSrc(BlendFactor)", asMETHOD(Sprite, SetBlendFactorSrc), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "BlendFactor GetBlendFactorDst()", asMETHOD(Sprite, GetBlendFactorDst), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetBlendFactorDst(BlendFactor)", asMETHOD(Sprite, SetBlendFactorDst), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "DrawModeOperation GetDrawMode()", asMETHOD(Sprite, GetDrawMode), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetDrawMode(DrawModeOperation)", asMETHOD(Sprite, SetDrawMode), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "CullingOperation GetCulling()", asMETHOD(Sprite, GetCulling), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetCulling(CullingOperation)", asMETHOD(Sprite, SetCulling), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "DepthOperation GetDepth()", asMETHOD(Sprite, GetDepth), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "void SetDepth(DepthOperation)", asMETHOD(Sprite, SetDepth), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "bool HitTest(double, double, OrthoCamera@)", asMETHOD(Sprite, HitTest), asCALL_THISCALL); if (result < 0) { return false; }

	result = m_engine->RegisterObjectType("Text", sizeof(0), asOBJ_REF | asOBJ_NOCOUNT); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "uint GetID()", asMETHOD(Text, GetID), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "Vec3F& GetAnchor()", asMETHOD(Text, GetAnchor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetAnchor(Vec3F)", asMETHOD(Text, SetAnchor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "Vec3F& GetRotation()", asMETHOD(Text, GetRotation), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetRotation(Vec3F)", asMETHOD(Text, SetRotation), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "Vec3F& GetSkew()", asMETHOD(Text, GetSkew), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetSkew(Vec3F)", asMETHOD(Text, SetSkew), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "Vec3F& GetScale()", asMETHOD(Text, GetScale), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetScale(Vec3F)", asMETHOD(Text, SetScale), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "Vec3F& GetPosition()", asMETHOD(Text, GetPosition), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetPosition(Vec3F)", asMETHOD(Text, SetPosition), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "string GetText()", asMETHOD(Text, GetText), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetText(string)", asMETHOD(Text, SetText), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "string GetFontName()", asMETHOD(Text, GetFontName), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetFontName(string)", asMETHOD(Text, SetFontName), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "uint GetFontStyle()", asMETHOD(Text, GetFontStyle), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetFontStyle(uint)", asMETHOD(Text, SetFontStyle), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "uint GetFontSize()", asMETHOD(Text, GetFontSize), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetFontSize(uint)", asMETHOD(Text, SetFontSize), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "SizeF& GetTextSize()", asMETHOD(Text, GetTextSize), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "Color4F& GetTint()", asMETHOD(Text, GetTint), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetTint(Color4F)", asMETHOD(Text, SetTint), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "BlendOperation GetBlend()", asMETHOD(Text, GetBlend), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetBlend(BlendOperation)", asMETHOD(Text, SetBlend), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "BlendFactor GetBlendFactorSrc()", asMETHOD(Text, GetBlendFactorSrc), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetBlendFactorSrc(BlendFactor)", asMETHOD(Text, SetBlendFactorSrc), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "BlendFactor GetBlendFactorDst()", asMETHOD(Text, GetBlendFactorDst), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetBlendFactorDst(BlendFactor)", asMETHOD(Text, SetBlendFactorDst), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "DrawModeOperation GetDrawMode()", asMETHOD(Text, GetDrawMode), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetDrawMode(DrawModeOperation)", asMETHOD(Text, SetDrawMode), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "CullingOperation GetCulling()", asMETHOD(Text, GetCulling), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetCulling(CullingOperation)", asMETHOD(Text, SetCulling), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "DepthOperation GetDepth()", asMETHOD(Text, GetDepth), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "void SetDepth(DepthOperation)", asMETHOD(Text, SetDepth), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "bool HitTest(double, double, OrthoCamera@)", asMETHOD(Text, HitTest), asCALL_THISCALL); if (result < 0) { return false; }

	result = m_engine->RegisterObjectType("Fog", sizeof(0), asOBJ_REF | asOBJ_NOCOUNT); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "uint GetID()", asMETHOD(Fog, GetID), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "Vec3F& GetAnchor()", asMETHOD(Fog, GetAnchor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "void SetAnchor(Vec3F)", asMETHOD(Fog, SetAnchor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "Vec3F& GetRotation()", asMETHOD(Fog, GetRotation), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "void SetRotation(Vec3F)", asMETHOD(Fog, SetRotation), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "Vec3F& GetSkew()", asMETHOD(Fog, GetSkew), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "void SetSkew(Vec3F)", asMETHOD(Fog, SetSkew), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "Vec3F& GetScale()", asMETHOD(Fog, GetScale), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "void SetScale(Vec3F)", asMETHOD(Fog, SetScale), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "Vec3F& GetPosition()", asMETHOD(Fog, GetPosition), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "void SetPosition(Vec3F)", asMETHOD(Fog, SetPosition), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "FogOperation GetFog()", asMETHOD(Fog, GetFog), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "void SetFog(FogOperation)", asMETHOD(Fog, SetFog), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "Color3F& GetFogColor()", asMETHOD(Fog, GetFogColor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "void SetFogColor(Color3F)", asMETHOD(Fog, SetFogColor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "float GetFogStart()", asMETHOD(Fog, GetFogStart), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "void SetFogStart(float)", asMETHOD(Fog, SetFogStart), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "float GetFogEnd()", asMETHOD(Fog, GetFogEnd), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "void SetFogEnd(float)", asMETHOD(Fog, SetFogEnd), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "float GetFogDensity()", asMETHOD(Fog, GetFogDensity), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "void SetFogDensity(float)", asMETHOD(Fog, SetFogDensity), asCALL_THISCALL); if (result < 0) { return false; }

	result = m_engine->RegisterObjectType("Lighting", sizeof(0), asOBJ_REF | asOBJ_NOCOUNT); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "uint GetID()", asMETHOD(Lighting, GetID), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Vec3F& GetAnchor()", asMETHOD(Lighting, GetAnchor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetAnchor(Vec3F)", asMETHOD(Lighting, SetAnchor), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Vec3F& GetRotation()", asMETHOD(Lighting, GetRotation), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetRotation(Vec3F)", asMETHOD(Lighting, SetRotation), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Vec3F& GetSkew()", asMETHOD(Lighting, GetSkew), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetSkew(Vec3F)", asMETHOD(Lighting, SetSkew), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Vec3F& GetScale()", asMETHOD(Lighting, GetScale), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetScale(Vec3F)", asMETHOD(Lighting, SetScale), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Vec3F& GetPosition()", asMETHOD(Lighting, GetPosition), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetPosition(Vec3F)", asMETHOD(Lighting, SetPosition), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "LightsOperation GetLights()", asMETHOD(Lighting, GetLights), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLights(LightsOperation)", asMETHOD(Lighting, SetLights), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Color3F& GetAmbientLight()", asMETHOD(Lighting, GetAmbientLight), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetAmbientLight(Color3F)", asMETHOD(Lighting, SetAmbientLight), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "LightOperation GetLight1()", asMETHOD(Lighting, GetLight1), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight1(LightOperation)", asMETHOD(Lighting, SetLight1), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Vec3F& GetLight1Position()", asMETHOD(Lighting, GetLight1Position), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight1Position(Vec3F)", asMETHOD(Lighting, SetLight1Position), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "float GetLight1Distance()", asMETHOD(Lighting, GetLight1Distance), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight1Distance(float)", asMETHOD(Lighting, SetLight1Distance), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Color4F& GetLight1Diffuse()", asMETHOD(Lighting, GetLight1Diffuse), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight1Diffuse(Color4F)", asMETHOD(Lighting, SetLight1Diffuse), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "LightOperation GetLight2()", asMETHOD(Lighting, GetLight2), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight2(LightOperation)", asMETHOD(Lighting, SetLight2), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Vec3F& GetLight2Position()", asMETHOD(Lighting, GetLight2Position), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight2Position(Vec3F)", asMETHOD(Lighting, SetLight2Position), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "float GetLight2Distance()", asMETHOD(Lighting, GetLight2Distance), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight2Distance(float)", asMETHOD(Lighting, SetLight2Distance), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Color4F& GetLight2Diffuse()", asMETHOD(Lighting, GetLight2Diffuse), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight2Diffuse(Color4F)", asMETHOD(Lighting, SetLight2Diffuse), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "LightOperation GetLight3()", asMETHOD(Lighting, GetLight3), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight3(LightOperation)", asMETHOD(Lighting, SetLight3), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Vec3F& GetLight3Position()", asMETHOD(Lighting, GetLight3Position), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight3Position(Vec3F)", asMETHOD(Lighting, SetLight3Position), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "float GetLight3Distance()", asMETHOD(Lighting, GetLight3Distance), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight3Distance(float)", asMETHOD(Lighting, SetLight3Distance), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Color4F& GetLight3Diffuse()", asMETHOD(Lighting, GetLight3Diffuse), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight3Diffuse(Color4F)", asMETHOD(Lighting, SetLight3Diffuse), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "LightOperation GetLight4()", asMETHOD(Lighting, GetLight4), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight4(LightOperation)", asMETHOD(Lighting, SetLight4), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Vec3F& GetLight4Position()", asMETHOD(Lighting, GetLight4Position), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight4Position(Vec3F)", asMETHOD(Lighting, SetLight4Position), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "float GetLight4Distance()", asMETHOD(Lighting, GetLight4Distance), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight4Distance(float)", asMETHOD(Lighting, SetLight4Distance), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Color4F& GetLight4Diffuse()", asMETHOD(Lighting, GetLight4Diffuse), asCALL_THISCALL); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "void SetLight4Diffuse(Color4F)", asMETHOD(Lighting, SetLight4Diffuse), asCALL_THISCALL); if (result < 0) { return false; }
	...
	result = m_engine->RegisterObjectMethod("Node", "OrthoCamera@ opCast()", asFUNCTION((refCast<Node ,OrthoCamera>)), asCALL_CDECL_OBJLAST); if (result < 0) { return false; }
	...
	result = m_engine->RegisterObjectMethod("Node", "Fog@ opImplCast()", asFUNCTION((refCast<Node, Fog>)), asCALL_CDECL_OBJLAST); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Fog", "Node@ opImplCast()", asFUNCTION((refCast<Fog, Node>)), asCALL_CDECL_OBJLAST); if (result < 0) { return false; }

	result = m_engine->RegisterObjectMethod("Node", "Lighting@ opImplCast()", asFUNCTION((refCast<Node, Lighting>)), asCALL_CDECL_OBJLAST); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Lighting", "Node@ opImplCast()", asFUNCTION((refCast<Lighting, Node>)), asCALL_CDECL_OBJLAST); if (result < 0) { return false; }

	result = m_engine->RegisterObjectMethod("Node", "Sprite@ opImplCast()", asFUNCTION((refCast<Node, Sprite>)), asCALL_CDECL_OBJLAST); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Sprite", "Node@ opImplCast()", asFUNCTION((refCast<Sprite, Node>)), asCALL_CDECL_OBJLAST); if (result < 0) { return false; }
	
	result = m_engine->RegisterObjectMethod("Node", "Text@ opImplCast()", asFUNCTION((refCast<Node, Text>)), asCALL_CDECL_OBJLAST); if (result < 0) { return false; }
	result = m_engine->RegisterObjectMethod("Text", "Node@ opImplCast()", asFUNCTION((refCast<Text, Node>)), asCALL_CDECL_OBJLAST); if (result < 0) { return false; }
