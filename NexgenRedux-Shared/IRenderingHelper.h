...
namespace NexgenRedux
{
	...
	public:
		...
		virtual void SetAmbientLight(const MathUtility::Color3I& color) = 0;
		virtual void SetTexture(const uint32_t& textureID, const TextureFilter& filter) = 0;
		virtual void SetTint(const MathUtility::Color4I& color) = 0;
		...
		virtual void SetLightInstance1(const MathUtility::Vec3F& position, const float& distance, const MathUtility::Color4I& diffuse) = 0;
		virtual void SetLight2(const LightOperation& operation) = 0;
		virtual void SetLightInstance2(const MathUtility::Vec3F& position, const float& distance, const MathUtility::Color4I& diffuse) = 0;
		virtual void SetLight3(const LightOperation& operation) = 0;
		virtual void SetLightInstance3(const MathUtility::Vec3F& position, const float& distance, const MathUtility::Color4I& diffuse) = 0;
		virtual void SetLight4(const LightOperation& operation) = 0;
		virtual void SetLightInstance4(const MathUtility::Vec3F& position, const float& distance, const MathUtility::Color4I& diffuse) = 0;
		virtual void SetFog(const FogOperation& operation) = 0;
		virtual void SetFogInstance(const MathUtility::Color3I& color, const float& start, const float& end, const float& density) = 0;
